...
clear
rm -f /usr/bin/user
username=$(curl https://raw.githubusercontent.com/Xdecod/izinsc/main/ip | grep $MYIP | awk '{print $2}')
echo "$username" >/usr/bin/user
expx=$(curl https://raw.githubusercontent.com/Xdecod/izinsc/main/ip | grep $MYIP | awk '{print $3}')
echo "$expx" >/usr/bin/e
...
Exp1=$(curl https://raw.githubusercontent.com/Xdecod/izinsc/main/ip | grep $MYIP | awk '{print $4}')
if [[ $today < $Exp1 ]]; then
sts="${Info}"
else
sts="${Error}"
...
# LINK REPOSITORY
REPO="https://raw.githubusercontent.com/Xdecod/UltraSonic/main/"
CONFIG="https://raw.githubusercontent.com/Xdecod/fodder/main/"
########################################################
...
if [[ $(grep -w ID /etc/os-release | cut -d '=' -f2 | tr -d '\"') == "debian" ]]; then
    ...
    # Setup for HAProxy
    curl -fsSL https://haproxy.net/bernat.org.gpg | gpg --dearmor -o /usr/share/keyrings/haproxy.net.gpg
...
#curl https://haproxy.net/bernat.org.gpg |
#gpg --dearmor >/usr/share/keyrings/haproxy.net.gpg
#echo deb "[signed-by=/usr/share/keyrings/haproxy.net.gpg]" \
#http://haproxy.net buster-backports-1.8 main \
...
# LINK REPOSITORY
MENUREPO="https://raw.githubusercontent.com/Xdecod/UltraSonic/main/"
...
clear
restart_system() {
USRSC=$(wget -qO- https://raw.githubusercontent.com/Xdecod/izinsc/main/ip | grep $ipsaya | awk '{print $2}')
EXPSC=$(wget -qO- https://raw.githubusercontent.com/Xdecod/izinsc/main/ip | grep $ipsaya | awk '{print $3}')
TIMES="10"
CHATID="5970831071"
...
cd /bin
git clone  https://github.com/Xdecod/wondershaper.git
cd wondershaper
sudo make install
cd
rm -rf wondershaper
